...
- 所有坐标均为相对于当前位置的偏移，以当前位置为原点(0, 0, 0)
- 例如：当前在(0,0,0)，第1个航点(5,0,-3)，第2个航点(10,1,-3)
  表示先飞到前方5米高3米处，再继续前进到前方10米右侧1米处

输出格式要求（严格JSON，不要有任何多余文字）：
{
  "waypoints": [
    {"x": 5.0, "y": 0.0, "z": -3.0, "description": "上升至3米高度并前进5米"},
    {"x": 10.0, "y": 1.0, "z": -3.0, "description": "继续前进5米并向右偏移1米"}
  ],
  "action_after": "hover",
  "summary": "向前飞10米，2个航点"
}
