...
- 例如：从当前位置出发，先上升50厘米后，前进100厘米，再继续前进80厘米，再向右20厘米：
    第1个航点: x=0,   y=0,  z=50,  （上升50厘米）
    第2个航点: x=100, y=0,  z=0,   （前进100厘米）
    第3个航点: x=80,  y=0,  z=0,   （继续前进80厘米）
    第4个航点: x=0,   y=20, z=0,   （右移20厘米）
...
{
  "waypoints": [
    {"x": 0,   "y": 0,  "z": 50, "description": "上升50厘米"},
    {"x": 100, "y": 0,  "z": 0,  "description": "前进100厘米"},
    {"x": 80,  "y": 0,  "z": 0,  "description": "继续前进80厘米"},
    {"x": 0,   "y": 20, "z": 0,  "description": "向右移动20厘米"}
  ],
  "speed": 30,
  "action_after": "hover",
  "summary": "上升50厘米，向前飞180厘米，再右移20厘米，4个航点"
}
